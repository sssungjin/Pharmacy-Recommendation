...
public class KakaoUriBuilderService {
    ...
    public URI buildUriByCategorySearch(double latitude, double longitude, double radius, String category) {
        double meterRadius = radius * 1000; // km -> m
        ...
        log.info("[KakaoAddressSearchService buildUriByCategorySearch] latitude: {}, longitude: {}, radius: {}, category: {}, uri: {}", latitude, longitude, radius, category, uri);
